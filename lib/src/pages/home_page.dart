...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _homeBloc = HomePageBloc(gitRepository: GitRepository());
        ...
        body: Stack(
          children: <Widget>[
            ...
            AnimatedContainer(
                ...
                height:120,
                margin: EdgeInsets.only(top: 72, left: 12, right: 12),
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                          color: Colors.black26, blurRadius: _searchElevation)
                    ]),
                child: Column(
                  children: <Widget>[
                    TextField(
                      onSubmitted: (query) {
                        ...
                        _homeBloc.dispatch(
                            HomePageEventSearch(jobPosition: _positionController.text,jobLocation: _locationController.text));
                      },
